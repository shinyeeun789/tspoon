...
<div class="menu">
    <ul>
        ...
        <li>
            <a href="#service"><i class="fa-solid fa-user-tie"></i> 서비스 </a>
        </li>
        <li>
            <a href="#notice"><i class="fa-solid fa-gift"></i></i> 공지사항 </a>
        </li>
        <li>
            <a href="#event"><i class="fa-solid fa-book"></i> 이벤트 </a>
        </li>
        <li>
            <a href="#lecture"><i class="fa-brands fa-youtube"></i> 추천 강의 </a>
        </li>
    </ul>
</div>
