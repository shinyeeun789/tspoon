...
<section class="hero is-medium" style="background-image: url('${path}/resources/images/pageHeader.jpg'); background-size: cover; background-position: top;">
    <nav class="breadcrumb has-dot-separator ml-5 mt-5" aria-label="breadcrumbs">
        <ul>
            ...
            <li>
                <a href="${path}/admin/memberMgmt.do" class="has-text-white">
                        <span class="icon is-small">
        ...
        <div class="columns">
            <div class="column is-3">
                <aside class="menu">
                    ...
                    <ul class="menu-list">
                        <li><a href="${path}/admin/memberMgmt.do" class="is-active">회원 관리</a></li>
                ...
                <table class="table is-hoverable is-fullwidth has-text-centered">
                    ...
                    <c:forEach items="${memberList }" var="member" varStatus="status">
                        <tr>
                            ...
                            <td><a href="${path}/admin/memberDelete.do?id=${member.id}" class="button is-danger is-small is-fullwidth">강퇴</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
