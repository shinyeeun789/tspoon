...
<section class="section" style="background-image: url('${path}/resources/images/bg-dots.png')">
    <div class="container">
    ...
    제33조(분쟁의 해결) "회사"는 분쟁이 발생하였을 경우에 "이용자"가 제기하는 정당한 의견이나 불만을 반영하여 적절하고 신속한 조치를 취합니다. 다만, 신속한 처리가 곤란한 경우에 "회사"는 "이용자"에게 그 사유와 처리일정을 통보합니다.
                    ...
                    <article class="agree_fr mb-20 mt-6">
    제1장 총칙
    ...
    ③ 법 시행 전에 개인정보를 수집한 개인정보처리자는 기존의 수집목적 범위에도 불구하고 제1항 단서 및 제2항을 준수하기 위하여 새롭게 정보주체의 동의를 받을 목적으로 법 시행 전에 수집한 개인정보를 이용할 수 있다.
                    ...
                    <div class="column is-6-tablet is-12 has-text-right">
                        <button class="btn btn-primary" id="in_btn1"> 다음 단계 </button>
                    </div>
                </div>
            </div>
        </div>
