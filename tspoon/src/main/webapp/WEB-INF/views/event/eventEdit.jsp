                    ...
                    <form action="${path }/event/edit.do" method="post">
                        <div class="columns is-multiline">
                            <div class="form-group column is-12">
                                ...
                                <input type="text" name="title" id="title" placeholder="제목 입력" maxlength="98" class="input" value="${detail.title}" required>
                            ...
                            <div class="form-group column is-12">
                                ...
                                <input type="date" name="sdate" id="sdate" class="input" placeholder="시작일 지정해주세요" autocomplete="off" value="${detail.sdate}" required>
                            </div>
                            <div class="form-group column is-12">
                                <label class="edate">종료일</label>
                                <input type="date" name="edate" id="edate" class="input" placeholder="종료일 지정해주세요" autocomplete="off" value="${detail.edate}" required>
                            </div>
                        </div>
                        <div class="form-group column is-12">
